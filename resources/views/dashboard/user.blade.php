...
{{-- KONTEN UTAMA: DOKUMEN TERBARU & STATISTIK CHART --}}
<div class="row g-3">
                ...
                @foreach ($kategoris as $kategori)
                    <li class="d-flex justify-content-between align-items-center py-2 border-top">
                        <span class="d-flex align-items-center gap-2 small">
                            <span class="d-inline-block rounded-circle kategori-dot-{{ $kategori->warna ?? 'secondary' }}" style="width:14px;height:14px;"></span>
                            {{ $kategori->nama }}
                        </span>
